export default function CV() {
  return (
    <div>
	<h2 className="text-2xl py-2 text-purple-800">CV</h2>
	<h3 className="font-semibold my-2">Academic degrees</h3>
	<ul>
	...
	<h3 className="font-semibold my-2">Certificates</h3>
	<ul>
	...
	<h3 className="font-semibold" my-2>Research specialism</h3>
	<ul>
	<li>Computer vision</li>
	<li>Machine learning</li>
	</ul>

	<h3 className="font-semibold" my-2>Skills & experience</h3>
	<ul>
