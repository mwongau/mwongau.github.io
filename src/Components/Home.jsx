...
export default function Home() {
  ...
  return (
	<div>
		...
		React.js, Vite, Javascript, HTML and Tailwind CSS. This site is hosted by GitHub Pages.</p>					
		</div>
		
		<p className="bg-gray-100 mt-5" style={mystyle}> This site uses cookies to improve your browsing 
