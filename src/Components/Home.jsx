export default function Home() {
  return (
	<div>
		<h2>Home</h2>		
		<div>
		<p>Welcome to my personal website. I am a researcher in computer vision and machine 
		...
		React, Vite, React Router, Javascript, HTML and CSS. This site is hosted by GitHub 
		Pages.</p>					
		</div>			
	</div>	
  );
